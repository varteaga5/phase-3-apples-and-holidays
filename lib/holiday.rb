...
def add_supply_to_winter_holidays(holiday_hash, supply)
  ...
  # iterate over hash, 
  # shovel supply to each arr
  
  holiday_hash[:winter].each{|holiday_arr, supplies| supplies << supply}
...
def add_supply_to_memorial_day(holiday_hash, supply)
  ...
  holiday_hash[:spring].each{|holiday_arr, supplies| supplies << supply}
...
def add_new_holiday_with_supplies(holiday_hash, season, holiday_name, supply_array)
  ...
  holiday_name_and_supplies = holiday_name => {supply_array}
  holiday_hash[season] = holiday_name_and_supplies
end
